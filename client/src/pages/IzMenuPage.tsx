  ...
  return (
    <div className="min-h-screen bg-base-200">
      ...
      <div className="container mx-auto p-4">
        <h2 className="text-3xl font-bold text-center my-6 text-navy">IZ Menu Items</h2>
        {izMenu.items.length === 0 ? (
